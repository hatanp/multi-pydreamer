...
#export MLFLOW_EXPERIMENT_NAME="minerl_new"
#export MLFLOW_S3_IGNORE_TLS=true

#export MLFLOW_TRACKING_INSECURE_TLS="true"
#export MLFLOW_RUN_NAME=$SLURM_JOB_ID
#export MLFLOW_RESUME_ID="minerl_resume"
export MLFLOW_RUN_ID="1ccb7fb8f8e44a4ea2ce5db2934b4368"
export MLFLOW_TRACKING_URI="file:///scratch/project_462000007/hatanpav/output/mlflow/mlruns"
